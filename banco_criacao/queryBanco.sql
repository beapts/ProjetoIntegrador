...
INSERT INTO `plantinhas`.`produtos` (`nome`, `id_categoria_fk`, `preco`, `quantidade`, `produto_img`, `descricao_curta`, `descricao_longa`) VALUES ('Vaso Barro Pequeno', '2', '45,00', '8', '/images/plants/vasos/severin-candrian-y0C-eGur0nU-unsplash.jpg', 'Vaso de barro - Coloração Natural', 'Vaso ou jarra é uma peça em forma de jarro que é utilizado para decorar salas, recepções, corredores ou ainda para decorar espaços abertos, como escadas ou jardins. Sua função é meramente ornamental, sendo utilizado para armazenar flores.');
INSERT INTO `plantinhas`.`produtos` (`nome`, `id_categoria_fk`, `preco`, `quantidade`, `produto_img`, `descricao_curta`, `descricao_longa`) VALUES ('Vaso Cinza pequeno', '2', '68,00', '12', '/images/plants/vasos/severin-candrian-JtrKQzJt3vk-unsplash.jpg', 'Vaso de cimento cinza - Pequeno', 'Vaso ou jarra é uma peça em forma de jarro que é utilizado para decorar salas, recepções, corredores ou ainda para decorar espaços abertos, como escadas ou jardins. Sua função é meramente ornamental, sendo utilizado para armazenar flores.');
INSERT INTO `plantinhas`.`produtos` (`nome`, `id_categoria_fk`, `preco`, `quantidade`, `produto_img`, `descricao_curta`, `descricao_longa`) VALUES ('Dupla Vasos ', '2', '89,00', '12', '/images/plants/vasos/severin-candrian-SOhatM1jFLk-unsplash.jpg', 'Dupla de vasos de ceramica branco', 'Vaso ou jarra é uma peça em forma de jarro que é utilizado para decorar salas, recepções, corredores ou ainda para decorar espaços abertos, como escadas ou jardins. Sua função é meramente ornamental, sendo utilizado para armazenar flores.');
INSERT INTO `plantinhas`.`produtos` (`nome`, `id_categoria_fk`, `preco`, `quantidade`, `produto_img`, `descricao_curta`, `descricao_longa`) VALUES ('Vaso Cinza Grande', '2', '100,00', '8', '/images/plants/vasos/severin-candrian-SOhatM1jFLk-unsplash.jpg', 'Vaso de cimento cinza - Grande', 'Vaso ou jarra é uma peça em forma de jarro que é utilizado para decorar salas, recepções, corredores ou ainda para decorar espaços abertos, como escadas ou jardins. Sua função é meramente ornamental, sendo utilizado para armazenar flores.');
